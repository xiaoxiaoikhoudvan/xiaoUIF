<template>
    <template v-if="visible">
        <Teleport to="body">
            <div class="xiao-dialog-overlay" @click="closeOnClickOverlay"></div>
            <div class="xiao-dialog-wrapper">
            <div class="xiao-dialog">
                <header>
                    <slot name="title" />
                    <span @click="close" class="xiao-dialog-close"></span>
                </header>
                <main>
                    <slot name="content" />
                </main>
